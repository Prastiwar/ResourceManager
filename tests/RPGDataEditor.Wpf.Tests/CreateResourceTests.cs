...
namespace RPGDataEditor.Wpf.Tests
{
    ...
    {
        private readonly Models.Dialogue dialogue = new Models.Dialogue() {
            Id = int.MaxValue / 2,
            StartQuestId = 1,
            Title = "TestTitle",
        ...
        private readonly Models.Quest quest = new Models.Quest() {
            Id = int.MaxValue / 2,
            Title = "TestTitle",
            Category = "TestCategory",
            Message = "TestMessage",
        ...
        private readonly Models.Npc npc = new Models.Npc() {
            Id = int.MaxValue / 2,
            Name = "TestName",
