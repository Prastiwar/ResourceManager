...
//                    TModel oldModel = (TModel)await Context.ConnectionService.Client.GetAsync(model);
//                    TModel newModel = oldModel;
//                    newModel.Category = newCategory;

//                    bool saved = await Context.ConnectionService.Client.UpdateAsync(oldModel, newModel);
//                    if (!saved)
//                    {
