...
namespace ResourceManager.Wpf.Controls
{
    public class ResourcePicker : UserControl
    {
        ...
        {
            ResourceManager.Mvvm.Services.IDialogService service = Application.Current.TryResolve<ResourceManager.Mvvm.Services.IDialogService>();
            ResourceManager.Mvvm.Navigation.IDialogResult result =
